...
# else:
#     ALLOWED_HOSTS = ["darkquiz.mooo.com", "icurfer.shop", "192.168.45.193", "127.0.0.1"]
    #ALLOWED_HOSTS = []
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('SQL_HOST', '10.2.1.101'),
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, '_static') #저장경로
